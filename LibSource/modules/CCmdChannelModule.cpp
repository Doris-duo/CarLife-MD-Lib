...
CCmdChannelModule::~CCmdChannelModule() {
	pInstance = NULL;
}
...
int CCmdChannelModule::cmdCarOil(S_CAR_OIL* oil) {
	return tranRecvPackageProcess.sendCmdCarOil(oil);
}
...
// 0x00018056
int CCmdChannelModule::cmdVideoEncoderJPEG() {
	return tranRecvPackageProcess.cmdVideoEncoderJPEG();
}

// 0x00010057
void CCmdChannelModule::cmdRegisterVideoEncoderJPEGAck(void (*pFunc)(void)) {
	tranRecvPackageProcess.cmdRegisterVideoEncoderJPEGAck(pFunc);
}

// 0x00010058
void CCmdChannelModule::cmdRegisterBtHfpCallStatusCover(void (*pFunc)(S_CALL_STATUS_COVER*)) {
	tranRecvPackageProcess.cmdRegisterBtHfpCallStatusCover(pFunc);
}

// 0x00010059
void CCmdChannelModule::cmdRegisterMdExit(void (*pFunc)(void)) {
	tranRecvPackageProcess.cmdRegisterMdExit(pFunc);
}
