...
class CTranRecvPackageProcess{
	public:
		...
		/*** Add MD interface  ***/
		//=============video channel [MD->HU]===========
		int sendVideoData(u8*data, u32 size, u32 timeStamp);
		//============media channel [MD->HU]=============
		int sendMediaData(u8*data, u32 size, u32 timeStamp);
		//============vr channel [MD->HU]=============
		int sendVRReportData(u8*data, u32 size, u32 timeStamp);
		//============tts channel [MD->HU]=============
		int sendTTSData(u8*data, u32 size, u32 timeStamp);
